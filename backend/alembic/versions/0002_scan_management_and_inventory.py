...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('asset_id', 'port', 'protocol', name='uq_services_asset_port_proto')
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('scan_id', 'asset_id', 'vulnerability_id', 'service_id', name='uq_scan_findings_composite')
    )
    ...
    op.create_index(op.f('ix_scan_findings_asset_id'), 'scan_findings', ['asset_id'], unique=False)
    op.create_index(op.f('ix_scan_findings_vulnerability_id'), 'scan_findings', ['vulnerability_id'], unique=False)
    op.create_index(op.f('ix_scan_findings_service_id'), 'scan_findings', ['service_id'], unique=False)
