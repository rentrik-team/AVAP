...
class ScanFinding(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        Index(
            ...
            "service_id",
            unique=True,
            sqlite_where=vulnerability_id.is_(None) & service_id.isnot(None),
            postgresql_where=vulnerability_id.is_(None) & service_id.isnot(None),
        ),
        Index(
            ...
            "vulnerability_id",
            unique=True,
            sqlite_where=vulnerability_id.isnot(None) & service_id.is_(None),
            postgresql_where=vulnerability_id.isnot(None) & service_id.is_(None),
        ),
        Index(
            ...
            "asset_id",
            unique=True,
            sqlite_where=vulnerability_id.is_(None) & service_id.is_(None),
            postgresql_where=vulnerability_id.is_(None) & service_id.is_(None),
        ),
    )
